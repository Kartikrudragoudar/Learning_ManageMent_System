# Generated by Django 5.2.1 on 2025-06-21 19:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('Review', 'Review'), ('Disabled', 'Disabled'), ('Draft', 'Draft'), ('Published', 'Published')], default='Processing', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('English', 'English'), ('French', 'French')], default='English', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('varaint_id', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', length=6, max_length=20, prefix='', unique=True)),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.course')),
            ],
        ),
